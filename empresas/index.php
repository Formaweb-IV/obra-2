	...
	<div class="container mb-4">
		<div class="container mb-5">
			<div class="row">
				...
				<div class="col">
					<a href="functions/nuevo.php" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-building" viewBox="0 0 16 16">
